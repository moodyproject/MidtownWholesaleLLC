      ...
      <div className={styles.container}>
        <div className={styles.footerContent}>
          <div className={styles.footerSection}>
            ...
            <p className={styles.tagline}>A warehouse you can trust.</p>
          </div>
          ...
          <div className={styles.footerSection}>
            ...
            <div className={styles.contactInfo}>
              <div className={styles.contactItem}>
                ...
                <span>midtownwholesalewi@gmail.com</span>
              </div>
              <div className={styles.contactItem}>
                <svg className="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
                </svg>
                <span>(414) 828-8178</span>
              </div>
              <div className={styles.contactItem}>
                <svg className="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                ...
                <span>4830 S 10th St, Milwaukee, WI 53221</span>
              </div>
            </div>
          </div>
        ...
        <div className={styles.footerBottom}>
          <p>&copy; {currentYear} Midtown Wholesale LLC. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
